 ...
 */
let myFavouriteSong = "Die with a smile";
...
console.log(`I live in ${userLocation}.`);
/*
 * Prompt 3:
 *
...
console.log(secretNum + 2);
console.log(secretNum - 2);
console.log(secretNum * 3);
console.log(secretNum / 7);
console.log(secretNum % 2);
/*
 * Prompt 4:
 *
...
const movies = ["Star Wars", "Lala Land", "Lion King", "Frozen"];
console.log(movies[1]);
movies.unshift("Mulan");
console.log(movies);
movies.push("Harry Potter");
console.log(movies);
movies.splice(2, 0, "Twilight");
console.log(movies);
/*
 *
...
const secondToLast = array4[array4.length - 2];
